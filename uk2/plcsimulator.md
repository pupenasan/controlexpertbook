...
![image-20250816123203000](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816123203000.png)
...
![image-20250816132531304](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816132531304.png)

![image-20250816132446858](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816132446858.png)
...
| ------------------------------------------------------------ | ----------------------------- | ------------------------------------------------------------ |
| ![image-20250816132921798](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816132921798.png) | NOCONF (без конфігурації)     | Немає завантаженого користувацького проєкту, або завантажений проєкт є недійсним чи видалений командою Clear. |
| ![image-20250816132935415](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816132935415.png) | IDLE                          | Проєкт, завантажений у контролер, не запущений або скинутий кнопкою Reset. |
| ![image-20250816132949331](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816132949331.png) | STOPPED                       | Жоден проєкт не виконується.                                 |
| ![image-20250816133002858](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816133002858.png) | RUN                           | Виконується проєкт з принаймні однією задачою                |

Колір внутрішнього символу показує стан з’єднання

| Приклад                                                      | Колір    | Опис                                     |
| ------------------------------------------------------------ | -------- | ---------------------------------------- |
| ![image-20250816133140381](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816133140381.png) | чорний   | Немає підключеного TCP/IP-клієнта.       |
| ![image-20250816133202791](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816133202791.png) | червоний | Принаймні один TCP/IP-клієнт підключено. |

Стан помилок

| Символ                                                       | Стан симульованого контролера | Опис                                                         |
| ------------------------------------------------------------ | ----------------------------- | ------------------------------------------------------------ |
| ![image-20250816133534814](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816133534814.png) | HALT                          | У проєкті виникла помилка. Симульований контролер необхідно повторно ініціалізувати або скинути за допомогою кнопки Reset. |
| ![image-20250816133558777](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816133558777.png) | ERROR                         | У проєкті виявлено невиправну помилку. Це означає, що зв’язок більше неможливий. Симульований контролер необхідно скинути за допомогою кнопки Reset. |
...
| Символ                                                       | Стан симульованого контролера | Опис                                                         |
| ------------------------------------------------------------ | ----------------------------- | ------------------------------------------------------------ |
| ![image-20250816133638992](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816133638992.png) | POWER OFF                     | Виникла внутрішня помилка під час симуляції скидання контролера або циклу живлення. |
| ![image-20250816133657440](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816133657440.png) | INIT                          | Виникла внутрішня помилка під час ініціалізації PLC Simulator. |
| ![image-20250816133712088](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816133712088.png) | UNKNOWN                       | PLC Simulator перейшов у невизначений стан.                  |
...
![image-20250816134943042](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816134943042.png)
...
![image-20250816135857874](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816135857874.png)
...
![image-20250816144850294](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816144850294.png)
...
![image-20250816150631260](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816150631260.png)
...
![image-20250816154453380](C:\san\Навч посіб M340\GitVer\uk2\media\image-20250816154453380.png)
